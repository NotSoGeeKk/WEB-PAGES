...
function checkInputs() {
  ...
  if (usernameValue === "") {
    alert(username, "UserName cannot be blanc.");
  } else {
  ...
  //###################################
  if (emailValue === "") {
    alert(email, "Email cannot be blanc.");
  } else {
  ...
  //###################################
  if (passwordValue === "") {
    alert(password, "Password connot be blanc.");
  } else {
  ...
  //###################################
  if (password2Value === "") {
    alert(password2, "Password connot be blanc.");
  } else if (password2Value !== passwordValue) {
    alert(password2, "Password dose not match.");
  } else {
